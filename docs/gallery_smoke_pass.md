...
Updated: 2026-05-27 for `PHOTO-DELETE-AVATAR-UPLOAD-FIX-04`.
...
| --- | --- | --- | --- |
| A | Avatar upload | NOT TESTED | Login account A, open Profile, choose JPEG/PNG/WebP avatar, verify in-app preview appears with visible Cancel / Choose another / Upload avatar actions, tap Upload avatar, verify new avatar appears, restart app, verify avatar persists from backend, open public profile, verify URL is backend/public HTTPS and not `file://`. |
