  ...
  switch (activity) {
    case "chain_draw":
      return {
        ...
        routeText: historyMode
          ? "Полная история остаётся главным местом для replay, статуса и возврата в чат."
          : "Сейчас здесь принимается решение, а затем история переходит в общий архив и чат.",
      };
    case "daily_prompt":
      return {
    ...
    case "color_mood":
      return {
        ...
        routeText: historyMode
          ? "Полная история остаётся главным местом для палитры, статуса и возврата в чат."
          : "Сейчас здесь принимается решение, а затем история переходит в общий архив и чат.",
      };
    case "draw":
    default:
  ...
  switch (outcome) {
    case "open_open":
      return {
        ...
        description: "Вы оба выбрали открыть и перевели эту сессию в личный чат.",
      };
    case "open_skip":
      return {
        shortLabel: "Один пропустил",
        description: "Один участник выбрал открыть, а второй решил оставить всё в истории.",
      };
    case "skip_skip":
      return {
        shortLabel: "Оба пропустили",
        description: "Вы оба решили оставить эту сессию только в совместной истории.",
      };
    default:
      return {
        shortLabel: "Ждём решение второго",
        description: "Одно решение уже сохранено, второе ещё не пришло.",
      };
  }
}
