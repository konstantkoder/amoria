...
function mockNearby(lat: number, lng: number) {
  const base = [
    {
      displayName: "Ana",
      interests: ["сальса", "кофе", "путешествия"],
      goal: "dating",
      mood: "happy",
    },
    {
      displayName: "Mia",
      interests: ["спорт", "кино", "языки"],
      goal: "friends",
      mood: "active",
    },
    {
      displayName: "Ivana",
      interests: ["йога", "рисование", "море"],
      goal: "long_term",
      mood: "chill",
    },
    {
      displayName: "Sara",
      interests: ["кулинария", "трекинг", "музыка"],
      goal: "dating",
      mood: "party",
    },
    {
      displayName: "Natalia",
      interests: ["фото", "книги", "self-care"],
      goal: "chat",
      mood: "serious",
    },
  ];
