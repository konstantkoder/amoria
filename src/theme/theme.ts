...
export const theme = {
  colors: {
    ...
    surfaceWarm: "rgba(243,201,139,0.10)",
    ...
    success: "#46E0C8",
    danger: "#FF4D67",
    primaryActionBg: "#F3C98B",
    primaryActionText: "#24150B",
    primaryActionBorder: "rgba(255,219,159,0.55)",
    primaryActionPressedBg: "#E6B976",
    secondaryActionBg: "rgba(255,255,255,0.07)",
    secondaryActionText: "#F3C98B",
    ghostActionText: "rgba(243,201,139,0.92)",
    chipBg: "rgba(255,255,255,0.07)",
    chipActiveBg: "rgba(243,201,139,0.16)",
    chipActiveBorder: "rgba(243,201,139,0.42)",
    dangerBg: "rgba(255,77,103,0.16)",
    dangerText: "#FFD2DA",
    successBg: "rgba(31,185,110,0.15)",
    successText: "#B9F6D2",
    warningBg: "rgba(243,201,139,0.13)",
    warningText: "#F3C98B",
    ...
    borderWarm: "rgba(243,201,139,0.34)",
    shadowColor: "#000000",
  },
  ...
  buttons: {
    ...
    ghost: {
      ...
      textColor: "rgba(243,201,139,0.92)",
      fontSize: 13,
      lineHeight: 17,
      fontWeight: "900" as const,
      pressedOpacity: 0.62,
    ...
    chip: {
      ...
      backgroundColor: "rgba(255,255,255,0.07)",
      borderColor: "rgba(255,255,255,0.12)",
      activeBackgroundColor: "rgba(243,201,139,0.16)",
      activeBorderColor: "rgba(243,201,139,0.42)",
      textColor: "rgba(226,232,255,0.86)",
      activeTextColor: "#F9FAFF",
      fontSize: 12,
      lineHeight: 15,
      fontWeight: "900" as const,
      iconSize: 14,
