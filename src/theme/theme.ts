...
export const theme = {
  colors: {
    ...
    surfaceWarm: "rgba(255,210,170,0.09)",
    ...
    success: "#46E0C8",
    danger: "#FF4D67",
    primaryActionBg: "#FFD2AA",
    primaryActionText: "#21130A",
    primaryActionBorder: "rgba(255,232,204,0.64)",
    primaryActionPressedBg: "#FFC08A",
    secondaryActionBg: "rgba(255,255,255,0.07)",
    secondaryActionText: "#FFD2AA",
    ghostActionText: "rgba(255,210,170,0.92)",
    chipBg: "rgba(255,255,255,0.07)",
    chipActiveBg: "rgba(255,210,170,0.15)",
    chipActiveBorder: "rgba(255,210,170,0.40)",
    dangerBg: "rgba(255,77,103,0.16)",
    dangerText: "#FFD2DA",
    successBg: "rgba(31,185,110,0.15)",
    successText: "#B9F6D2",
    warningBg: "rgba(255,210,170,0.12)",
    warningText: "#FFD2AA",
    ...
    borderWarm: "rgba(255,210,170,0.34)",
    shadowColor: "#000000",
  },
  ...
  buttons: {
    primary: {
      ...
      borderColor: "rgba(255,232,204,0.64)",
      textColor: "#21130A",
      fontSize: 15,
      lineHeight: 18,
    ...
    secondary: {
      ...
      borderColor: "rgba(255,210,170,0.24)",
      textColor: "#FFD2AA",
      fontSize: 14,
      lineHeight: 18,
      fontWeight: "900" as const,
    ...
    ghost: {
      ...
      textColor: "rgba(255,210,170,0.92)",
      fontSize: 13,
      lineHeight: 17,
      fontWeight: "900" as const,
      pressedOpacity: 0.62,
    ...
    chip: {
      ...
      activeBackgroundColor: "rgba(255,210,170,0.15)",
      activeBorderColor: "rgba(255,210,170,0.40)",
      textColor: "rgba(226,232,255,0.86)",
      activeTextColor: "#FFD2AA",
      fontSize: 12,
      lineHeight: 15,
      fontWeight: "900" as const,
      iconSize: 14,
  ...
  cards: {
    ...
    warning: {
      ...
      padding: 12,
      borderRadius: 18,
      backgroundColor: "rgba(255,210,170,0.12)",
      borderColor: "rgba(255,210,170,0.34)",
      borderWidth: 1,
    },
